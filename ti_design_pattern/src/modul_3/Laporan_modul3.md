...
2. Selanjutnya, buat package baru di dalam folder `src` dengan cara klik kanan pada folder tersebut, lalu pilih menu **New → Package**. Berikan nama package tersebut **modul_3**.

3. Setelah itu, buat package baru lagi di dalam package `modul_3` dengan langkah yang sama, yaitu klik kanan kemudian pilih **New → Package**, lalu beri nama **bagian_1**.
...
1. Buat kembali sebuah package baru di dalam package `modul_3` dengan cara klik kanan, kemudian pilih **New → Package**, lalu beri nama **bagian_2**.
...
<br>
1. Buat kembali sebuah package baru di dalam package `modul_3` dengan cara klik kanan, kemudian pilih **New → Package**, lalu beri nama **bagian_3**.
...
```
package modul_3.bagian_3.compotition;
...
1. Buat kembali sebuah package baru di dalam package `modul_3` dengan cara klik kanan, kemudian pilih **New → Package**, lalu beri nama **bagian_4**.
...
1. Buat kembali sebuah package baru di dalam package `modul_3` dengan cara klik kanan, kemudian pilih **New → Package**, lalu beri nama **bagian_5**.
